...
trait EntrustUserTrait
{
    ...
    public function cachedRoles()
    {
     ...
     public function cachedPermissions()
     {
         ...
         if (Cache::getStore() instanceof TaggableStore) {
             return Cache::tags(Config::get('entrust.permissions_users_table'))->remember($cacheKey, Config::get('cache.ttl', 60), function () {
    ...
    {
        return $this->belongsToMany(Config::get('entrust.permission'), Config::get('entrust.permissions_users_table'), Config::get('entrust.user_foreign_key'), Config::get('entrust.permission_foreign_key'));
    }
