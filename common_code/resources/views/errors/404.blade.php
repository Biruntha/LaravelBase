    ...
    <div class="col-md-8 col-sm-12 offset-md-2">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="text-center fw-bold">Sorry, the page you look for doesn't exist</h1>
                <img src="/assets/images/pages/404.jpg" alt="404" class="img-fluid m-auto" style="max-width:600px"/>
